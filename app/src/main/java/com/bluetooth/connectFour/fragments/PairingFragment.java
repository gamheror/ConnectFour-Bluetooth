...
public class PairingFragment extends Fragment {
    ...
    private BluetoothActivity.Callback communicatorCallback;
    private CustomAnimator animator = new CustomAnimator();
    private Peer connectingPeer;
    protected Global global;
    protected BluetoothActivity activity;
    ...
    public void onStart() {
        ...
        if (!Tools.hasPermissions(activity, BluetoothActivity.REQUIRED_PERMISSIONS)) {
            startSearch();
        }
    ...
    protected void startSearch() {
        ...
        if (result != BluetoothCommunicator.SUCCESS) {
            ...
            } else if (result != BluetoothActivity.NO_PERMISSIONS && result != BluetoothCommunicator.ALREADY_STARTED) {
